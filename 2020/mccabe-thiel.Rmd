...
```{r plot_output, echo = FALSE, comment = NA}
...
Solution
========
  The slope of the q-line is given by: $slope\;=\;\frac{-q}{1-q}$. From the diagram, this slope is about $`r q_slope`$. The intercept of the rectifying line on the y-axis is given by $intercept\;=\;\frac{x_D}{1+R_{min}}$ so $ `r rmin_intercept` \;=\; \frac{ `r distil`}{1 + R_{min}}$
